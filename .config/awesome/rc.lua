...
myawesomemenu = {
   { "manual", "termite -e 'man awesome'" },
   { "edit config", "termite -e 'nano /home/deathowl/.config/awesome/rc.lua'" },
...
music = {
   { "Ncmpcpp", "termite -e ncmpcpp"},
   { "M.O.C.","termite -e mocp"},
   {"Shell-fm","termite -e shell-fm"}
}
development={
   { "Sublime", "subl"},
   { "Pycharm","pycharm"}
